...
class Deck
{
    ...
    public function __construct( )
    {
		...
		$this->verso_test = "verso";
			...
			array_push($this->arrayCarte, new Carte("Princess"), new Carte("Countess"), new Carte("King"),  new Carte("Prince") 
				, new Carte("Guard"), new Carte("Guard"), new Carte("Guard"), new Carte("Prince"), new Carte("Guard"),  new Carte("Guard")
