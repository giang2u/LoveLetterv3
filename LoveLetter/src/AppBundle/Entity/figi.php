    ...
    <h1 align="middle"></h1>
		<div id="manche">
			...
			<div id="plateau" style="background-image: url({{ asset(plateau) }}); float:center ; width: cover; height: 400px; margin-right:100px; margin-left:100px" >
				...
				<div id="horsjeu">
				<img src="{{ asset(first) }}" align="center" height = 100  width = 75 alt="first" style="margin-top: 20px ; margin-bottom: 20px;"/>
				<img src="{{ asset(second) }}" align="center" height = 100  width = 75 alt="second" style="margin-top: 20px; margin-bottom: 20px;"/>
				<img src="{{ asset(trois) }}" align="center" height = 100  width = 75 alt="trois" style="margin-top: 20px; margin-bottom: 20px;"/>
